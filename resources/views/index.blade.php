...
{{-- 
<div
class="box-content relative w-full h-64 max-w-6xl pb-0 mx-auto  overflow-hidden rounded-b-none shadow-2xl lg:pb-32 md:h-88 lg:h-96 rounded">
<img src="" class="absolute object-cover object-top w-full h-auto">
</div> --}}
